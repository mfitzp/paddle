...
latex_documents = [
  ('index', 'Paddle.tex', u'Paddle Documentation',
...
man_pages = [
    ('index', 'paddle', u'Paddle Documentation',
...
texinfo_documents = [
  ('index', 'Paddle', u'Paddle Documentation',
   u'Martin A. Fitzpatrick, Catherine M. McGrath, Stephen P. Young', 'Paddle', 'One line description of project.',
   'Miscellaneous'),
]
