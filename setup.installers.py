...
__version__ = open(os.path.join('paddle','VERSION'),'rU').read()
print __version__
...
try:
    ...
    build_all['include_files']=[
        ...
        ('paddle/database', 'database'),
        ('paddle/plugins', 'plugins'),
        ('paddle/demos', 'demos'),
        ('paddle/identities', 'identities'),
        ('paddle/html', 'html'),
        ('paddle/icons', 'icons'),
        ]
    ...
    build_mac['iconfile'] = 'paddle/static/icon.icns'
    base = None
    if sys.platform == "win32":
        base = "Win32GUI"
        build_exe['include_msvcr'] = True
        build_exe['icon'] = 'paddle/static/icon.ico'
...
setup(
    ...
    url='https://github.com/paddle/paddle',
    download_url='https://github.com/paddle/paddle/zipball/master',
    description='Metabolic pathway visualisation and analysis.',
    long_description='Paddle is workflow-based scientific data processing, analysis and \
